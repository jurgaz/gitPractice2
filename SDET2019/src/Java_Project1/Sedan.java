...
public class Sedan extends Car {
	...
	public Sedan(int mpg, double currentSpeed, boolean engineStatus, String name, String make, String model,
			int maxSpeed, int year, String owner) {
		super(mpg, currentSpeed, engineStatus, name, make, model, maxSpeed, year, owner);
		
	}

	public Sedan(int mpg, double currentSpeed, boolean engineStatus) {
	...
	public String toString() {
		return "Sedan [mpg=" + mpg + ", currentSpeed=" + currentSpeed + ", engineStatus=" + engineStatus + ", name="
